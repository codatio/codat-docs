...
var mapIntegrationRedirect = function mapIntegrationRedirect(item, category) {
  return {
    to: item.to,
    from: "/redirects/integrations/"
      .concat(category, "/")
      .concat(item.platformKey),
  };
};
var mapIntegrationRedirects = function mapIntegrationRedirects(
  items,
  category,
) {
...
module.exports = {
  redirects: [
    ...
    prodRework,
    _toConsumableArray(mapIntegrationRedirects(acc, "accounting")),
    _toConsumableArray(mapIntegrationRedirects(bank, "banking")),
    _toConsumableArray(mapIntegrationRedirects(comm, "commerce")),
  ),
