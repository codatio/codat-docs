...
const getPackageName = (productName, language) => {
  ...
  switch (language) {
    ...
    case "python":
      return (
        "codat-" + (productName !== "bank-feeds" ? productName : "bankfeeds")
      );
    case "csharp":
  ...
  switch (language.name) {
    ...
    default:
      return (
        ...
        language.shield +
        "/v/" +
        getPackageName(productName, language.name)
      );
  }
};
...
<img
  loading="lazy"
  src="https://img.shields.io/maven-central/v/io.codat/lending?label=maven-central%20(java)"
  alt="Maven Central (Java)"
              ...
              <div className="content">
                ...
                {productName !== undefined ? (
                  ...
                  >
                    <img
                      loading="lazy"
                      src={getShieldUrl(productName, language)}
                      alt={language.alt}
                    />
                  </a>
                ) : null}
