...
const usecases = [
  {
    ...
    description: "Grow card volume by accessing deeper spend insights from more clients through seamless data sharing.",
  ...
  },
  {
    ...
    description: "Automate data collection processes and make more confident credit decisions for your customers. ",
  ...
  },
  {
    ...
    description: "Become your customers’ go-to payment platform by automating their financial processes in real time.",
