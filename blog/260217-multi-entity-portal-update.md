...
This improvement benefits all of our customers, but is especially critical for enterprise clients managing complex, high-volume multi-entity structures.

## How to get started?

No action is required to benefit from this update. You will see these improvements in the [Codat Portal](https://app.codat.io) from **February 25, 2026**.
