...
<p>
  To build integrations for small business lending, try our <b>Assess</b> product.{" "}
  If you're developing accounting integrations for a PoS or eCommerce platform, go to <b>Sync for Commerce</b>.
</p>
<p>
  Building something else? Explore our <b>Accounting API</b>, <b>Open Banking API</b>, and{" "}
  <b>Commerce API</b> to pull, push, transform and visualize data from 35+ financial data sources, integrated with a single data model.
</p>
...
<ul className="card-container">
  <li className="card">
    ...
    <p>
      See our{" "}
      <a href="/accounting-api/overview">
...
<ul className="card-container">
  <li className="card">
    ...
    <p>
      ...
      <a href="/introduction/first-steps">
...
<ul className="card-container">
  <li className="card">
    ...
    <p>
      <a href="/core-concepts/companies">
        Companies
      </a>{" "}
      and their <a
