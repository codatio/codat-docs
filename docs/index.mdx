...
<ul className="card-container">
  ...
  <li className="card">
    ...
    <p>
      Read our guide to{" "}
      <a href="/assess/get-started" target="_blank">
  ...
  <li className="card">
    ...
    <p>
      ...
      <a href="/sfc/overview" target="_blank">
        how to get started
      </a>
      .
    </p>
  ...
  <li className="card">
    ...
    <p>
      <a href="/sync-for-expenses/overview" target="_blank">
        Read more
      </a>{" "}
      or{" "}
...
<ul className="card-container">
  <li className="card">
    ...
    <p>
      ...
      and their{" "}
      <a href="/core-concepts/connections" target="_blank">
        data connections
      </a>{" "}
      are at the heart of Codat - find out more about how to create and use
      them.
    </p>
  </li>
  <li className="card">
