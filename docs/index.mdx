...
<ul className="card-container">
  ...
  <li className="card">
    ...
    <p>
      <a href="/usecases/summary/managing-expenses"><b>Discover expense management →</b></a>
    </p>    
  </li>
  <li className="card">
    <div className="header">
  ...
  <li className="card">
    ...
    <p>
      <a href="/usecases/summary/reconciling-bank-transactions"><b>Discover bank transactions reconciliation →</b></a>
    </p>
  </li>
</ul>
