...
- [Sales](https://docs.codat.io/docs/xero-mapping-specification#sales)
- [Fees](https://docs.codat.io/docs/xero-mapping-specification#fees)
- [Payments](https://docs.codat.io/docs/xero-mapping-specification#payments)
...
1. Select the accounts for **[Sales](https://docs.codat.io/docs/xero-mapping-specification#sales-1)**, **[Refunds](https://docs.codat.io/docs/xero-mapping-specification#refunds)**, **[Gratuity](https://docs.codat.io/docs/xero-mapping-specification#gratuity)**, and **[Prepaid](https://docs.codat.io/docs/xero-mapping-specification#prepaid)** features from the respective dropdown lists. The lists display all the applicable accounts available on the merchant’s Xero accounting platform.
...
To learn more about the configuration of **Payments**, navigate to the [Payments](https://docs.codat.io/docs/xero-mapping-specification#payments) section.

#### Refunds

Refunds represent a catch-all for all refunds, cash or non-cash.

Similar to **[Sales](https://docs.codat.io/docs/xero-mapping-specification#sales)**, **Refunds** are usually booked on a nominal account that the merchant uses to book their revenue, of the Xero type **Revenue**.

Typically, merchants would push **[Sales](https://docs.codat.io/docs/xero-mapping-specification#sales)** and **Refunds** into the same account. However, they can use a different account if they wish to report them separately.
...
The purchase of prepaid items will appear as a line item on the daily **[Sales](https://docs.codat.io/docs/xero-mapping-specification#sales)** invoice in Xero.

Note that when a customer uses the prepaid item (for example, purchases an item with a gift card), this is processed as a normal sale (see **[Sales](https://docs.codat.io/docs/xero-mapping-specification#sales)**).

## Fees

The Fees feature encompasses the transactions that involve the commerce service provider, including **[Payment fees](https://docs.codat.io/docs/xero-mapping-specification#payment-fees)** that a commerce platform charges the merchant for processing their card transactions and **[Payment fee refunds](https://docs.codat.io/docs/xero-mapping-specification#payment-fee-refunds)**.
...
Payment accounts contain cash. This is in contrast to all the accounts discussed in the **[Sales](https://docs.codat.io/docs/xero-mapping-specification#sales)** and **[Fees](https://docs.codat.io/docs/xero-mapping-specification#fees)** sections, which are nominal accounts and represent accounting concepts rather than hard cash.
...
For example, if the merchant processes ten card payments and twenty cash payments in one day, two payments are pushed. These payments are recorded against the daily sales invoice (see **[Sales](https://docs.codat.io/docs/xero-mapping-specification#sales)**).
