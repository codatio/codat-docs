...
A list of the available options in the company's accounting software can be retrieved from the [bankAccounts](/sync-for-payroll-api#/operations/list-accounts) endpoint:
...
You'll need to build an interface that lists all the payroll components of your system, and allows the user to set which account in their accounting software it corresponds to.
