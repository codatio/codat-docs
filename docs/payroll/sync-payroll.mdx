...
If you want to see a history of all pushOperations for your company, you can retrieve4 these from the [get-company-push-history](/sync-for-payroll-api#/operations/get-company-push-history) endpoint.