...
[Sync for Payroll API](/sync-for-payroll-api) supports HR, payroll, and vertical SaaS companies integrate their product with their customers' accounting platforms. 
