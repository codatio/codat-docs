...
_Version 2_ supports our legacy [Enhanced Financials](/lending/enhanced-financials/legacy/financials) endpoints. Continue using this version as your categories version if you are still calling these endpoints, as described in this article.
:::
