...
Your SMB user has now successfully connected their chosen bank accounts to QuickBooks Online. The status of the data connection is set to `Linked`, which allows you to [push bank feeds to QuickBooks Online](https://docs.codat.io/docs/accounting-qbo-bank-feeds-push-bank-transactions) for the SMB user.
