...
You can also start a sync manually using our [_Latest Sync_](/sync-for-commerce-api#/operations/post-sync-latest) endpoint, or [learn more](/sfc/learn/initiating-a-sync) about initiating it. Alternatively, you can [read more](/sfc/learn/synchronization-schedule) about sync periods and the sync schedule.
