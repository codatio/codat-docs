...
- Review and change which accounts within their accounting software to write the data into (see [Mapping specifications](/sfc/mapping-specifications/overview) for more information)
...
You can [set up a webhook](/using-the-api/webhooks/legacy/core-rules-create) for the [Sync Connection Deleted](/using-the-api/webhooks/legacy/core-rules-types#sync-connection-deleted) rule to be notified if a merchant severs their connection.
:::
