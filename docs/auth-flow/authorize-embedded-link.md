...
| `onFinish`     | Called when the user   executes the required steps of the connection flow and clicks the   "Complete" button.<br/> We recommend removing the `CodatLink` component   in this callback.                                                                    |                                                                                                                                                                                                                                                                            |
