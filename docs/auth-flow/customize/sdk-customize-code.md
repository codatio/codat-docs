...
| `landing.nextButton`                     |`string` <br/><br/>Text displayed on the continuation button of the landing page.|
...
| `accounting.dataAccess.nextButton`<br/>`banking.dataAccess.nextButton`<br/>`commerce.dataAccess.nextButton`        |`string` <br/><br/>Text displayed on the continuation button of the final flow page before connecting an accounting, banking or commerce  platform.|
