...
|**reportDate**|*string*, See [Date](/common-api#/schemas/DateTime)|YYYY-MM-DD, Users can specify a specific date, however the response will be provided for the full month.|Required|
...
|**start**|*string*, See [Date](/common-api#/schemas/DateTime)|YYYY-MM-DD, Date in which the period begins (inclusive).|
|**end**|*string*, See [Date](/common-api#/schemas/DateTime)|YYYY-MM-DD, Date in which the period ends (inclusive).|
