---
title: "Enhanced Profit and Loss for eCommerce lenders"
description: "Endpoint reference to produce a fully categorized profit and loss using the revised categorization version for eCommerce lenders"
createdAt: "2023-01-25T13:57:24.867Z"
updatedAt: "2023-01-27T15:26:01.665Z"
---
:::caution Account category versions
The categories outlined here will not be returned by the older [Enhanced Profit and Loss](/assess/reports/enhanced-financials/profit-and-loss) endpoint. It uses an [older version](/assess/categories/) of the account category taxonomy.
:::
...
| **accountCategory** 	| _object_<br/>See [Account Category](/assess/reports/enhanced-financials-ecommerce-lenders/profit-and-loss#account-category) 	| An object containing the suggested or confirmed account categories, up to five levels.  	|
...
| **levels** 	| _object_<br/>See [Levels](/assess/reports/enhanced-financials-ecommerce-lenders/profit-and-loss#levels)  	| An object containing an ordered list of account category levels.                                                                         	|
