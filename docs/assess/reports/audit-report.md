...
Data types can be enabled using <a href="https://api.codat.io/swagger/index.html#/Profile/post_profile_syncSettings" target="_blank">Codat's API</a> or in the <a className="external" href="/core-concepts/data-type-settings" target="_blank">Portal</a>.
