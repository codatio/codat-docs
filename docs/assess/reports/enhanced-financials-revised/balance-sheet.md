...
| **accountCategory** 	| _object_<br/>See [Account Category](/assess/reports/enhanced-financials-revised/balance-sheet#account-category) 	| An object containing the suggested or confirmed account categories, up to five levels.  	|
...
| **levels** 	| _object_<br/>See [Levels](/assess/reports/enhanced-financials-revised/balance-sheet#levels)  	| An object containing an ordered list of account category levels.                                                                         	|
