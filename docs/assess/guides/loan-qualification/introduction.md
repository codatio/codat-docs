...
The codebase uses Codat and its [Assess](/assess/overview) product to make a lending decision. We will walk you through the setup in the Portal and the code [next](/assess/guides/lending/setting-up). 
