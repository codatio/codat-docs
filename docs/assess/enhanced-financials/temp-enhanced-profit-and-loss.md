---
title: "Temp-Enhanced Profit and Loss"
hidden: true
createdAt: "2022-08-02T07:22:22.602Z"
updatedAt: "2022-10-27T10:56:07.292Z"
---
...
**Dimensions**
_Enhanced Profit and Loss_ consists of five dimensions that are always returned in the following order:

1. Period (index 0): Defined in months and is ordered from earliest to latest, e.g. April 2021, May 2021 ... March 2022.
2. Category (index 1): The following categories are returned in this order:
   a. Income
   b. Expense
   c. Gross Profit
   d. Net Operating Profit
   e. Net Profit
3. Sub Type (index 2): This dimension is dynamic based on the company's underlying accounts. If a _Sub Type_ doesn't have an account, it won't appear in the list.
4. Detail Type (index 3): This dimension is dynamic based on the company's underlying accounts. If a _Detail Type_ doesn't have an account, it won't appear in the list.
5. Accounts (index 4): The underlying accounts in the company's Profit and Loss.
