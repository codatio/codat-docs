...
- Be linked to an accounting and banking source of data. You can do this either in the Codat [Portal](https://docs.codat.io/docs/get-started-2-connect) or using the Codat [API](https://docs.codat.io/docs/step-2-connect).
- Have bank accounts and bank transactions set to [sync](https://docs.codat.io/docs/data-sync-settings).
