...
_Version 2_ supports our classic [Enhanced Financials](/assess/reports/enhanced-financials) endpoints. Continue using this version as your categories version if you are calling these endpoints, as described in this article.

_Version 3_ is a revised version of account categories that supports our new [Enhanced Financials for eCommerce Lenders](/assess/reports/enhanced-financials-ecommerce-lenders) endpoints. Learn how to [categorize the accounts](/assess/reports/enhanced-financials-ecommerce-lenders/categorize-accounts.md) using _Version 3_ if you choose to use these endpoints.
:::
