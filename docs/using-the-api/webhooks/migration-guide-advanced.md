...
| ...the query and/or paging functionality on the List `/rules` endpoint <br/><br/> ![Static Badge](https://img.shields.io/badge/No_not_migrate-orange) | - Do not migrate <br/> - Contact your Codat representative and request to remain on the legacy webhooks service |  
