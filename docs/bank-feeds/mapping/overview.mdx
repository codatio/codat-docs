...
description: "Review and select the options available to you to provide an account mapping interface to your SMB customer"
...
* [QuickBooks Online](/bank-feeds/integrations/qbo/qbo-mapping) and [Sage](/bank-feeds/integrations/sage/sage-mapping)'s own interfaces