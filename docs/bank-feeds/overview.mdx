...
Be it a business current account, savings account, credit card or even a payments processor feed, Bank Feeds API allows an SMB's accounting software users to easily reconcile bank transactions generated in your app against entries, such as invoices and bills in their accounting platform.
