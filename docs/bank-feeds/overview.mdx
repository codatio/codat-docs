...
description: "Easily deploy an automated bank statement feed into your application to push bank transaction data into your customers' accounting software"
...
banner_text: "Easily deploy an automated bank statement feed into your application to push bank transaction data into your customers' accounting software"
...
Once your SMB customer completes the authorization and account mapping process, you can begin the automatic upload of bank statements by pushing transactions into the target bank account on the accounting software.
