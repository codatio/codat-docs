...
| **# of Expenses (new suppliers only)**            | Total number of expense transactions associated with new suppliers in the latest quarter.                                                                                                                                                                   | A high count relative to bill count suggests new suppliers are being paid outside of the formal supplier process.                             |
| **Expenses amount (new suppliers only)**          | Total value of expense transactions associated with new suppliers in the latest quarter.                                                                                                                                                                    | Add to bills amount for a complete picture of total spend with new suppliers.                                                                 |
