...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td style={{ verticalAlign: 'middle!important' }} rowspan="8"><i>Transaction Types</i></td>
      <td>Payments</td>
      <td>Supplier used</td>
      <td>Supplier used</td>
      <td>Supplier used</td>
      <td style={{ verticalAlign: 'middle!important' }} rowspan="8">Supplier is not associated with expense transactions due to a Dynamics platform limitation.</td>
    </tr>
    <tr>
      <td>Refund</td>
      <td>Customer used</td>
