...
<div className="container">
  <ul className="card-container">
    ...
    <li className="card animation-pulse">
      ...
      <p>
        Ask the Codat community a question on our {" "}
        <a href="https://github.com/orgs/codatio/discussions/new?category=q-a">GitHub</a>.
      </p>
    </li>
    <li className="card animation-pulse">
      <div className="header">
    ...
    <li className="card">
      ...
      <p>
        ...
        </a>{" "} directly with our product team
        .
      </p>
    </li>
    <li className="card">
    ...
    <li className="card">
      ...
      <p>
        <a href="mailto:AR@codat.io">Raise a billing inquiry</a> 
