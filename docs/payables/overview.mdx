...
Codat supports B2B payment and invoicing companies, payment providers, and vertical SaaS businesses with their integration requirements by leveraging the [Payables API](/payables-api) product. 
