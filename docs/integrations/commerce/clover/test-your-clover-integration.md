...
When you've [set up your Clover integration](https://docs.codat.io/docs/set-up-your-clover-integration), you're ready to test the authorization process for your integration. You'll need to:
