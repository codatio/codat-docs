...
When you've [set up PrestaShop](https://docs.codat.io/docs/set-up-prestashop-in-production), you're ready to test the authorization process for your integration. You'll need to:
...
- Set up [PrestaShop](https://docs.codat.io/docs/set-up-prestashop-in-production).
