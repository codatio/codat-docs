...
See [Set up the Stripe integration](https://docs.codat.io/docs/commerce-stripe-setup) for the steps you need to take to update your integration.
:::
...
See [Set up your Stripe integration](https://docs.codat.io/docs/commerce-stripe-setup) to learn how to set up and enable the integration.
