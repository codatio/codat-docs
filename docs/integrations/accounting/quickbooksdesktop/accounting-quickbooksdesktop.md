...
- Administrator privileges (admin rights) are needed to run the connector installer. Or, a different administrator can approve the installation and run the connector.
