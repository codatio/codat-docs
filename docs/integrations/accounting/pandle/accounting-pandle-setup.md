...
3. Next, go to the Codat portal where you've enabled your integration and [create a test company](https://docs.codat.io/docs/portal-managing-companies#add-a-new-company).
