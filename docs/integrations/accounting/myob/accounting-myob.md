...
For more details about the supported data types, see [MYOB integration reference](https://docs.codat.io/docs/myob-integration-reference).

## Set up the integration

See [Set up the MYOB integration](https://docs.codat.io/docs/accounting-myob-setup) to learn how to set up and enable the integration.
