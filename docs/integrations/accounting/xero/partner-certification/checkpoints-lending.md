...
| Provide a button to terminate the connection | When a user clicks on the button, use our [Unlink connection](/lending-api#/operations/unlink-connection) endpoint to disconnect from Xero. |
...
| Provide a disconnection process for off-boarding | Use our [Unlink connection](/lending-api#/operations/unlink-connection) endpoint to prevent further syncs or the [Delete connection](/lending-api#/operations/delete-connection) endpoint to prevent further syncs and querying of historically synced data.|
