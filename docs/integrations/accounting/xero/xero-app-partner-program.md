...
Once you have set up your Xero integration, you should consider becoming a [Xero App Partner](https://developer.xero.com/documentation/xero-app-store/app-partner-guides/grow-your-app-with-xero). This is an essential step if you want to use your Xero integration at scale (above 50 connections).
