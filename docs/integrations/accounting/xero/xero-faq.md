...
Yes. To push a batch payment to Xero, you push a [Bill payment](/accounting-api#/billpayments) with multiple line items. Pushing a batch payment to Xero will create the following business objects:
