...
To link more than 25 companies, you need to [become a Xero app partner](https://docs.codat.io/docs/accounting-xero-setup#apply-to-become-a-xero-app-partner).
...
For details on how to become a Xero app partner, see [Apply to become a Xero app partner](https://docs.codat.io/docs/accounting-xero-setup#apply-to-become-a-xero-app-partner).
...
To create a direct bank feed using Xero's Bank Feeds API, you push (`POST`) [Bank Transactions](https://docs.codat.io/docs/datamodel-accounting-banktransactions) via the Codat API. Bank transactions must be pushed in chronological order.
