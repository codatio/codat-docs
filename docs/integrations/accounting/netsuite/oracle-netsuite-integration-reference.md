...
When pulling Direct incomes, the default `-Not Taxable-` tax group and tax code are ignored. You can access this information by pulling the [Tax Rates](https://docs.codat.io/docs/datamodel-accounting-taxrates) data type.
...
"0-1": "[Bill credit notes](https://docs.codat.io/docs/datamodel-accounting-billcreditnotes)",
"0-2": "Not represented in Codat's accounting data model.",
"1-0": "`Invoice.customForm`, `Invoice.postingPeriod`",
"1-1": "[Invoices](https://docs.codat.io/docs/datamodel-accounting-invoices)",
"1-2": "Not represented in Codat's accounting data model.",
"2-0": "`Vendor.subsidiary`",
"2-1": "[Suppliers](https://docs.codat.io/docs/datamodel-accounting-suppliers)",
"2-2": "The Suppliers data type does not show whether or not a supplier company is a subsidiary.",
"3-0": "`Vendor.workCalendar`",
"3-1": "[Suppliers](https://docs.codat.io/docs/datamodel-accounting-suppliers)",
