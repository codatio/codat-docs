...
QuickBooks Online uses _expenses_ to record purchases that are paid immediately. Where these are recorded against a [supplier](https://docs.codat.io/docs/datamodel-accounting-suppliers), they are made available in Codat's [Bills](https://docs.codat.io/docs/datamodel-accounting-bills) and [Bill payments](https://docs.codat.io/docs/datamodel-accounting-billpayments) datasets.
...
In Codat, QBO's "classes" and "locations" are mapped to [tracking categories](https://docs.codat.io/docs/datamodel-accounting-trackingcategories).
