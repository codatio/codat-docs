...
The Sage 50 connector will be uninstalled if the user closes the connector before they've completed all the link flow steps (see [Set up the Sage 50 connector](https://docs.codat.io/docs/installing-the-sage-50-connector)).
