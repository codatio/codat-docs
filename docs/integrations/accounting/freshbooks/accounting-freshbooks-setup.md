...
4. Enter the following information into the boxes on the **Create Application** page:
   ...
   - **Scopes**: Add the scopes listed in [FreshBooks application scopes](https://docs.codat.io/docs/accounting-freshbooks-setup#freshbooks-application-scopes) on this page.
