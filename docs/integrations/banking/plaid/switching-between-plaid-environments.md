...
To avoid data inconsistencies, we recommend that you create new companies when you change environments. Any companies originally created in another environment are deauthorised and require [reauthorization](/integrations/banking/plaid/reauthorise-url-links).
:::
