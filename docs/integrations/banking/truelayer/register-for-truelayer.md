...
Follow the instructions in [Set up your TrueLayer integration](https://docs.codat.io/docs/set-up-truelayer-2) to create a TrueLayer account and configure your integration.
...
5. Follow the instructions in [Set up your TrueLayer integration](https://docs.codat.io/docs/set-up-truelayer-2) to configure your integration.
