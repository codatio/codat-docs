...
const routes = [
  {
    ...
    items: [
      ...
      ...composePaths(
        dataTypes.filter((dataType) => dataType.product === "accounting"),
      ),
    ],
  },
  {
    ...
    collapsed: true,
    items: [
      "data-model/banking/banking",
      ...composePaths(
        dataTypes.filter((dataType) => dataType.product === "banking"),
      ),
    ],
  },
  {
    ...
    collapsed: true,
    items: [
      "data-model/commerce/commerce",
      ...composePaths(
        dataTypes.filter((dataType) => dataType.product === "commerce"),
      ),
    ],
  },
  {
    ...
    collapsed: true,
    items: [
      "data-model/bank-feeds/bank-feeds",
      ...composePaths(
        dataTypes.filter((dataType) => dataType.product === "bank-feeds"),
      ),
    ],
  },
];
