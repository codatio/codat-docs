---
title: "Points de contrôle de certification Partenaire Paiements de Xero"
description: "Un guide pour obtenir la certification Paiements AP de Xero avec Codat"
---

Pour recevoir la certification Partenaire Xero, vous devez vous conformer aux points de contrôle de certification de Xero. Vous pouvez les consulter en détail dans la [propre documentation de Xero](https://developer.xero.com/documentation/xero-app-store/app-partner-guides/certification-checkpoints/).
...
Ce point de contrôle n'est pas pertinent pour les Partenaires Paiements car ils opèrent selon un modèle commercial différent des Partenaires App Store standard.
...
| Fournir un processus de déconnexion pour le désengagement                                           | Utilisez notre endpoint [Delete connection](/platform-api#/operations/delete-connection) pour empêcher d'autres synchronisations et interrogations des données historiquement synchronisées.                                                                                                                                                                                                                                    |
...
Ce point de contrôle est pertinent pour les applications qui créent, mettent à jour ou suppriment des données dans Xero.
