...
Utilisez le point de terminaison <a href={props.endpoint} target="_blank">Créer des factures</a> pour créer une nouvelle facture dans le logiciel comptable de votre client PME qui représente le paiement en attente pour des biens ou services achetés auprès d'un fournisseur.
