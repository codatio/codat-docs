...
class CodeChecker:
    ...
    def __init__(self, base_dir: Optional[Path] = None):
        ...
        try:
            ...
            raise RuntimeError(
                f"Failed to connect to Docker: {str(e)}. Make sure Docker is running."
            )
    ...
    def _build_docker_image(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            return (
                True,
                f"Docker build completed successfully. Image ID: {image_id[:12] if image_id else 'unknown'}",
            )
    ...
    def check_complete_snippets(self) -> Dict[str, Dict[str, any]]:
        ...
        total_passed = sum([python_success, typescript_success, csharp_success])
